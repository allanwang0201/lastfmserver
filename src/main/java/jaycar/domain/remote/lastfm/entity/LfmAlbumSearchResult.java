package jaycar.domain.remote.lastfm.entity;
...
public class LfmAlbumSearchResult {
    ...
    @JacksonXmlElementWrapper(localName = "albummatches")
    private List<LfmAlbum> albumList;
}
