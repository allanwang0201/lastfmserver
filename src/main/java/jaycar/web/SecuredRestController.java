...
import jaycar.domain.model.collection.artist.crud.UserArtistCollectionCrudRepo;
import jaycar.domain.model.collection.artist.crud.UserArtistCollectionEntryCrudRepo;
import jaycar.domain.model.entity.*;
import jaycar.domain.model.entity.crud.ArtistCrudRepo;
import jaycar.domain.model.entity.crud.LikedArtistCrudRepo;
import jaycar.domain.model.entity.crud.FriendCrudRepo;
import jaycar.domain.model.entity.crud.RecommendationCrudRepo;
import jaycar.domain.services.UserCollectionsService;
import jaycar.security.auth.api.TokenService;
import jaycar.security.auth.api.UserAuthenticationService;
import jaycar.security.entities.user.crud.api.UserCrudService;
import jaycar.security.entities.user.entity.User;
import jaycar.security.entities.user.entity.UserAndToken;
import jaycar.security.entities.user.entity.UserPublicInfo;
import jaycar.web.entity.ArtistNameAndMbid;
import jaycar.web.entity.RecommendArtistRequestBody;
