package jaycar.security.config;
...
class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        http
                ...
                // do not store sessions - re-authenticate on every request
                .sessionManagement()
                ...
                // provide an additional AuthenticationProvider - the one implemented by TokenAuthenticationProvider
                .authenticationProvider(provider)

                // add a filter that will extract the authentication impl
                ...
                // Disable some of the default settings
                .csrf().disable() // disable Cross Site Request Forgery protection
                .formLogin().disable() // disable form-based authentication (FormLoginConfigurer)
                .httpBasic().disable() // disable http-basic (HttpBasicConfigurer)
                .logout().disable(); // disable logout - we're not using sessions (LogoutConfigurer)
    }
